...
//        WebElement lnk_startHere =driver.findElement(By.partialLinkText("Start here."));
//        
//        
...
//            driver.findElement(By.id("continue")).click();
            ...
            System.out.println(CustomerConfirmPassword);
            
            driver.findElement(By.cssSelector("input#Email")).clear();
            driver.findElement(By.cssSelector("input#Email")).sendKeys(CustomerEmail);
